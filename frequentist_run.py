...
def run_frequentist_analysis(input_h5_file, model, N_s, g_s, L_s, Bbar_s,
    ...
    """
        ...
        L_s: List of L / a (Lattice Size) values to be studied, L values should
            be ints
        Bbar_s: List of Bbar crossing values to be studied, Bbar values should
            be floats
